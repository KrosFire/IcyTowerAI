...
class Species {
  ...
  sameSpecies(g) {
    ...
    var largeGenomeNormalizer = g.genes.length - 20;
    if (largeGenomeNormalizer < 1) {
      largeGenomeNormalizer = 1;
    }

    compatibility = (this.excessCoeff * excessAndDisjoint / largeGenomeNormalizer) + (this.weightDiffCoeff * averageWeightDiff); //compatibility formula
